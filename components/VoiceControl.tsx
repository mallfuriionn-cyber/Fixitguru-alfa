...
export const VoiceControl: React.FC<VoiceControlProps> = ({ isActive, onToggle }) => {
  return (
    <div className="flex items-center gap-4">
      <button
        onClick={onToggle}
        className={`relative w-12 h-12 flex items-center justify-center rounded-full transition-all active:scale-90 shadow-sm ${
      ...
      {isActive && (
        <div className="hidden md:flex gap-1.5 items-center px-5 py-2.5 bg-red-50 border border-red-100 rounded-full animate-synthesis-in">
